...
# on origossa ja jonka säde on yksi. Sen ympärille piirretään pienin
# mahdollinen neliö B siten, että ympyrä A jää kokonaan neliön sisäpuolelle.
...
# sievenee muotoon π/4. Tästä saadaan yksinkertainen menetelmä piin
# likiarvon laskemiseksi: Arvotaan neliön B sisälle suuri määrä satunnaisissa
# kohdissa olevia pisteitä, esimerkiksi miljoona. Olkoon N tämä pisteiden kokonaismäärä.
# Jokaisesta neliön B sisään arvotusta pisteestä testataan vuorollaan,
# jääkö se myös yksikköympyrän A sisälle. Olkoon n ympyrän sisälle jäävien
# pisteiden kokonaismäärä. Nyt pätee n/N≈π/4, josta saadaan π≈4n/N.
